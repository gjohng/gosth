## 一键部署 Gost(ss+mws) 到 heroku  [![Deploy](https://www.herokucdn.com/deploy/button.png)]((https://dashboard.heroku.com/new?template=https://github.com/gjohng/gosth)
...
[下载](https://github.com/ginuerzh/gost-heroku/releases/tag/v2.11.2)
